...
public class AccessTest {
    public static void main(String[] args) {
        ...
        while (isCount) {
            ...
            System.out.println("국어 : " + momo.KOR + " => " + ScoreKr);
            System.out.println("영어 : " + momo.ENG + " => " + ScoreEn);
            System.out.println("수학 : " + momo.MATH + " => " + ScoreMt);
            if (momo.isVaild()) {
            ...
            String confirm = System.console()
                    .readLine(
                            "Finish? ('y'or'Y') will turn off this.(If you want continue this method Please Insert any key)");
            switch (confirm) {
                case "Y", "y":
                    isCount = false;
                    break;
...
class Score {
    ...
    private boolean isKorV() {
        return KOR >= 0 && KOR <= 100;
    }

    private boolean isEngV() {
        return ENG >= 0 && ENG <= 100;
    }

    private boolean isMathV() {
